...
This repository includes R coding files for reproducing all analyses for CSKT AWARE. Currently, the repo includes analyses for project years 2 and year 3.

For each data type (e.g. survey), the data is first processed using a single R coding file. Mainly, this is for creating demographic variables and survey constructs, which are then combined and uses in anaysis. See the breakdown by year below
...
This script produces a single 📊 Excel file containing the following outputs:
